...
app.add_url_rule('/firework/savePlateSlots', methods=['POST'], view_func=quest.firework_savePlateSlots)
app.add_url_rule('/firework/changeAnimal', methods=['POST'], view_func=quest.firework_changeAnimal)
...
app.add_url_rule('/trainingGround/battleStart', methods=['POST'], view_func=quest.questBattleStart)
app.add_url_rule('/trainingGround/battleFinish', methods=['POST'], view_func=quest.questBattleFinish)
...
app.add_url_rule('/charRotation/createPreset', methods=['POST'], view_func=user.charRotation_createPreset)
app.add_url_rule('/charRotation/deletePreset', methods=['POST'], view_func=user.charRotation_deletePreset)
app.add_url_rule('/charRotation/updatePreset', methods=['POST'], view_func=user.charRotation_updatePreset)
app.add_url_rule('/charRotation/setCurrent', methods=['POST'], view_func=user.charRotation_setCurrent)
...
app.add_url_rule('/businessCard/editNameCard', methods=['POST'], view_func=user.businessCard_editNameCard)
app.add_url_rule('/businessCard/getOtherPlayerNameCard', methods=['POST'], view_func=user.businessCard_getOtherPlayerNameCard)
...
app.add_url_rule('/sandboxPerm/sandboxV2/switchMode', methods=['POST'], view_func=sandbox.switchMode)

app.add_url_rule('/sandboxPerm/sandboxV2/racing/learnTalent', methods=['POST'], view_func=sandbox.racing_learnTalent)
app.add_url_rule('/sandboxPerm/sandboxV2/racing/battleStart', methods=['POST'], view_func=sandbox.racing_battleStart)
app.add_url_rule('/sandboxPerm/sandboxV2/racing/battleFinish', methods=['POST'], view_func=sandbox.racing_battleFinish)
...
app.add_url_rule(
    '/setting/perf/setLowPower',
    methods=['POST'], view_func=user.setting_perf_setLowPower
)
